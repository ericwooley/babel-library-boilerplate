# generator-babel-lib [![Build Status](https://secure.travis-ci.org/ericwooley/generator-babel-lib.png?branch=master)](https://travis-ci.org/ericwooley/generator-babel-lib)
